...
This file supports local dev (SQLite) and production deploys on Render.
"""
...
DEBUG = os.getenv('DEBUG', '0' if IS_RENDER else '1').lower() in ('1', 'true', 'yes', 'on')
...
# Public site does not expose a portfolio login page.
# SkillSwap views that require auth specify their own login_url.
